      ...
      <div className="relative mx-auto max-w-7xl px-5 md:px-12">
        ...
        >
          ...
          <h2 className="text-3xl font-black leading-tight text-white md:text-4xl lg:text-5xl">
            Built for Players &amp; Venue Owners
          </h2>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-8">
          {/* ---- FOR PLAYERS ---- */}
          <motion.div
            className="group relative overflow-hidden rounded-2xl border border-[#e3e53e]/10 bg-white/[0.03] transition-all duration-300 hover:-translate-y-[4px] hover:border-[#e3e53e]/25 hover:shadow-[0_8px_40px_rgba(227,229,62,0.07)]"
          ...
          {/* ---- FOR VENUE OWNERS ---- */}
          <motion.div
            className="group relative overflow-hidden rounded-2xl border border-[#9dc4d5]/10 bg-white/[0.03] transition-all duration-300 hover:-translate-y-[4px] hover:border-[#9dc4d5]/25 hover:shadow-[0_8px_40px_rgba(157,196,213,0.07)]"
            initial={{ opacity: 0, y: 40 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-60px" }}
